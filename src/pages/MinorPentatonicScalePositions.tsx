...
const MinorPentatonicScalePositions: React.FC = () => {
  ...
  return (
    <>
      <Typography variant="body1" gutterBottom>
        <b>
          Find the <span style={{ color: "#1976d2" }}>{rootNote} minor</span> pentatonic scale here
        </b>
      </Typography>
      <FretboardDiagram
...
export default MinorPentatonicScalePositions;
