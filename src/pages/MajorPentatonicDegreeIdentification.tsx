...
const MajorPentatonicDegreeIdentification: React.FC = () => {
    ...
    <>
      <Typography variant="body1" gutterBottom>
        <b>
          ...
          <span style={{ color: ROOT_COLOR }}>{rootNote} major</span> pentatonic scale
        </b>
      </Typography>
      <FretboardDiagram
...
export default MajorPentatonicDegreeIdentification;
