...
const MinorPentatonicDegreeIdentification: React.FC = () => {
  const [round] = useState<PentatonicRound>(() =>
    generatePentatonicRound(NUM_FRETS_TO_SHOW, "minor")
  );
    ...
    <>
      <Typography variant="body1" gutterBottom>
        <b>
          ...
          <span style={{ color: ROOT_COLOR }}>{rootNote} minor</span> pentatonic scale
        </b>
      </Typography>
      <FretboardDiagram
...
export default MinorPentatonicDegreeIdentification;
